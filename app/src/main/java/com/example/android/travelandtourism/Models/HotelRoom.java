...
/*
* import io.realm.HotelRoomRealmProxy;
import io.realm.RealmObject;
* */

/*@Parcel(implementations = { Hotel.class },
        value = Parcel.Serialization.BEAN,
        analyze = { HotelRoom.class })*/
public class HotelRoom extends RealmObject implements Serializable {
